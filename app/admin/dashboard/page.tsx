...
export default function AdminDashboard() {
  ...
  const handleGeneratePDF = async () => {
    ...
    doc.text(`Active Candidates: ${candidates.length}`, 14, 72)
    doc.text(`Archived Candidates: ${archivedCandidates.length}`, 14, 78)
    
    // Candidates Table
    doc.setFontSize(14)
    doc.setFont("helvetica", "bold")
    doc.text("Candidate Results", 14, 92)
      ...
      <main className="container mx-auto px-4 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <Card className="p-6 backdrop-blur-xl bg-white/60 dark:bg-slate-900/60 border-white/20 shadow-xl">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-lg font-semibold">Voting Trend (Last 7 Days)</h3>
                </div>
                <div className="h-64">
            ...
            <Card className="p-6 backdrop-blur-xl bg-white/60 dark:bg-slate-900/60 border-white/20 shadow-xl">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-semibold">Top 5 Candidates</h3>
              </div>
              <div className="h-64">
            ...
            <Card className="p-6 backdrop-blur-xl bg-white/60 dark:bg-slate-900/60 border-white/20 shadow-xl">
              ...
              <div className="space-y-3">
                {analytics?.recentVotes.map((vote) => (
                  <div
                    key={vote.id}
                    className="flex items-center justify-between p-4 rounded-xl backdrop-blur-sm bg-white/50 dark:bg-slate-800/50 border border-white/20 hover:shadow-lg transition-all"
                  >
                    <div className="flex items-center gap-3">
          ...
          <TabsContent value="candidates" className="space-y-6">
            <div className="flex items-center justify-between gap-4 flex-wrap">
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className={candidatesView === "active" ? "" : "backdrop-blur-sm bg-white/50 dark:bg-slate-800/50"}
                >
                ...
                <Button
                  ...
                  className={candidatesView === "archived" ? "" : "backdrop-blur-sm bg-white/50 dark:bg-slate-800/50"}
                >
              ...
              <div className="flex items-center gap-2 flex-1 max-w-md">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-10 backdrop-blur-xl bg-white/60 dark:bg-slate-900/60 border-white/20"
                    value={searchTerm}
            ...
            <Card className="backdrop-blur-xl bg-white/60 dark:bg-slate-900/60 border-white/20 shadow-xl overflow-hidden">
              <Table>
                <TableHeader>
                  <TableRow className="border-white/20">
                    ...
                    {candidatesView === "archived" && <TableHead>Archived</TableHead>}
                  ...
                  {filteredCandidates.map((candidate) => (
                    <TableRow key={candidate.id} className="border-white/20">
                      ...
                      <TableCell>
                        <Badge 
                          variant="secondary"
                          className="backdrop-blur-sm bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 border-indigo-500/30"
                        >
                          {candidate.voteCount}
                        </Badge>
                      </TableCell>
                          ...
                          {candidatesView === "active" ? (
                            ...
                            <>
                              ...
                              <Button
                                ...
                                className="backdrop-blur-sm bg-red-500/10 hover:bg-red-500/20 border-red-500/30 text-red-600"
                              >
                  ...
                  {filteredUsers.map((user) => (
                    <TableRow key={user.id} className="border-white/20">
                      ...
                      <TableCell>
                        <Badge 
                          variant="outline"
                          className="backdrop-blur-sm bg-slate-500/10"
                        >
                      ...
                      <TableCell>
                        {user.hasVoted ? (
                          <Badge 
                            variant="success"
                            className="backdrop-blur-sm bg-green-500/20 text-green-700 dark:text-green-300 border-green-500/30"
                          >
                            Voted
                          </Badge>
                        ) : (
                          <Badge 
                            variant="warning"
                            className="backdrop-blur-sm bg-yellow-500/20 text-yellow-700 dark:text-yellow-300 border-yellow-500/30"
                          >
                            Not Voted
                          </Badge>
                        )}
